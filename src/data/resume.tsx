  ...
  work: [
    {
      ...
      description:
        "Build and maintain customer-facing digital onboarding journeys for Emirates NBD's banking and credit card products, including credit card applications, account opening, and KYC flows. Own 17+ regional bank websites across the GCC and Asia, ensuring consistent performance and UX across markets. Partner with business stakeholders to translate business logic into frontend requirements and write automation tests to reduce regression risk within an Agile delivery cadence.",
    },
    {
      company: "Halian",
      href: "https://www.halian.com",
      badges: [],
      location: "Dubai, UAE",
      ...
      description:
        "Built the authentication dashboard and core login, sign-up, and verification flows for OSN's streaming platform, translating design mockups into responsive, cross-browser-compatible interfaces. Integrated with backend APIs to ensure reliable authentication, delivering the full flow within a short, fast-paced project timeline.",
    },
    {
      company: "MOHRE",
      ...
      description:
        "Built and maintained internal government applications and enterprise employee portals, including Tawteen, a job portal connecting local Emirati talent with private-sector employers. Partnered with .NET developers to integrate frontend components with backend services and optimized asset loading and code structure to improve page performance across internal and public-facing platforms.",
    },
  ],
  education: [
    {
      school: "Aptech Worldwide",
